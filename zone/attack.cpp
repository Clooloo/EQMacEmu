...
int Client::GetHandToHandDamage()
{
	static uint8 mnk_dmg[] = { 99,
		6, 6, 6, 6, 7, 7, 7, 7, 7, 8,           // 1-10
		8, 8, 8, 8, 9, 9, 9, 9, 9, 10,           // 11-20
		10, 10, 10, 10, 11, 11, 11, 11, 11, 12,  // 21-30
		12, 12, 12, 12, 13, 13, 13, 13, 13, 14, // 31-40
		14, 14, 14, 14, 15, 15, 15, 15, 15, 16, // 41-50
		16, 16, 16, 16, 18, 18, 18, 18, 19, 20, // 51-60
		21, 22 };                                // 61-62
...
int Client::GetHandToHandDelay()
{
	...
	static uint8 mnk_iks_delay[] = { 99,
		...
		28, 28, 28, 28, 28, 28, 28, 28, 28, 28, // 51-60
		21, 20 };								// 61-62
